...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: GetLiveHlsStreamStreamOptions | Unset = UNSET,
    max_width: int | Unset = UNSET,
    max_height: int | Unset = UNSET,
    enable_subtitles_in_manifest: bool | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (GetLiveHlsStreamStreamOptions | Unset):
        max_width (int | Unset):
        max_height (int | Unset):
        enable_subtitles_in_manifest (bool | Unset):
