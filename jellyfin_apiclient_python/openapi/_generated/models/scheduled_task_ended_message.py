...
class ScheduledTaskEndedMessage:
    ...
    Attributes:
        data (None | TaskResult | Unset): Class TaskExecutionInfo.
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.SCHEDULEDTASKENDED.
    """

    data: None | TaskResult | Unset = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.SCHEDULEDTASKENDED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> None | TaskResult | Unset:
            if data is None:
                return data
