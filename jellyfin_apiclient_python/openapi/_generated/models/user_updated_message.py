...
class UserUpdatedMessage:
    ...
    Attributes:
        data (None | Unset | UserDto): Class UserDto.
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.USERUPDATED.
    """

    data: None | Unset | UserDto = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.USERUPDATED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> None | Unset | UserDto:
            if data is None:
                return data
