...
class PluginUninstalledMessage:
    ...
    Attributes:
        data (None | PluginInfo | Unset): This is a serializable stub class that is used by the api to provide
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.PACKAGEUNINSTALLED.
    """

    data: None | PluginInfo | Unset = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.PACKAGEUNINSTALLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> None | PluginInfo | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | PluginInfo | Unset, data)
