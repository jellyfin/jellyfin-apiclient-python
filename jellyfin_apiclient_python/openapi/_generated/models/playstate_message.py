...
class PlaystateMessage:
    ...
    Attributes:
        data (None | PlaystateRequest | Unset): Gets or sets the data.
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.PLAYSTATE.
    """

    data: None | PlaystateRequest | Unset = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.PLAYSTATE
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> None | PlaystateRequest | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | PlaystateRequest | Unset, data)
