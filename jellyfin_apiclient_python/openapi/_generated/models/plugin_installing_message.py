...
class PluginInstallingMessage:
    ...
    Attributes:
        data (InstallationInfo | None | Unset): Class InstallationInfo.
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.PACKAGEINSTALLING.
    """

    data: InstallationInfo | None | Unset = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.PACKAGEINSTALLING
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> InstallationInfo | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(InstallationInfo | None | Unset, data)
