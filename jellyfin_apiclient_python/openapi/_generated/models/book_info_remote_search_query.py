...
class BookInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (BookInfo | None | Unset):
        item_id (UUID | Unset):
    ...
    search_info: BookInfo | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> BookInfo | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(BookInfo | None | Unset, data)
