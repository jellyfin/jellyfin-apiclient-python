...
class GeneralCommandMessage:
    ...
    Attributes:
        data (GeneralCommand | None | Unset): Gets or sets the data.
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.GENERALCOMMAND.
    """

    data: GeneralCommand | None | Unset = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.GENERALCOMMAND
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> GeneralCommand | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(GeneralCommand | None | Unset, data)
