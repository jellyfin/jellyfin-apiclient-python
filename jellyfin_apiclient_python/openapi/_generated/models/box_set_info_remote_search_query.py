...
class BoxSetInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (BoxSetInfo | None | Unset):
        item_id (UUID | Unset):
    ...
    search_info: BoxSetInfo | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> BoxSetInfo | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(BoxSetInfo | None | Unset, data)
