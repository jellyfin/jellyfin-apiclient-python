...
class MusicVideoInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (MusicVideoInfo | None | Unset):
        item_id (UUID | Unset):
    ...
    search_info: MusicVideoInfo | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> MusicVideoInfo | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(MusicVideoInfo | None | Unset, data)
