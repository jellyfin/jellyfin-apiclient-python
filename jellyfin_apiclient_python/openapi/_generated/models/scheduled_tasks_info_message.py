...
class ScheduledTasksInfoMessage:
    ...
    Attributes:
        data (list[TaskInfo] | None | Unset): Gets or sets the data.
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.SCHEDULEDTASKSINFO.
    """

    data: list[TaskInfo] | None | Unset = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.SCHEDULEDTASKSINFO
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[TaskInfo] | None | Unset:
            if data is None:
                return data
