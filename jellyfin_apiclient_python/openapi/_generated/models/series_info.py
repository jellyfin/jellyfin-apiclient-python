...
class SeriesInfo:
    ...
    Attributes:
        ...
        provider_ids (None | SeriesInfoProviderIdsType0 | Unset): Gets or sets the provider ids.
    ...
    provider_ids: None | SeriesInfoProviderIdsType0 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_ids(
            data: object,
        ) -> None | SeriesInfoProviderIdsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | SeriesInfoProviderIdsType0 | Unset, data)
