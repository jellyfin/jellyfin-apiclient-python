...
class AlbumInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (AlbumInfo | None | Unset):
        item_id (UUID | Unset):
    ...
    search_info: AlbumInfo | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> AlbumInfo | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(AlbumInfo | None | Unset, data)
