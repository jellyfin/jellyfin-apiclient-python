...
class SyncPlayGroupDoesNotExistUpdate:
    ...
    Attributes:
        ...
        type_ (GroupUpdateType | Unset): Enum GroupUpdateType. Default: GroupUpdateType.GROUPDOESNOTEXIST.
    """

    group_id: UUID | Unset = UNSET
    data: str | Unset = UNSET
    type_: GroupUpdateType | Unset = GroupUpdateType.GROUPDOESNOTEXIST
