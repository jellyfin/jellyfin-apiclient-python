...
class SyncPlayLibraryAccessDeniedUpdate:
    ...
    Attributes:
        ...
        type_ (GroupUpdateType | Unset): Enum GroupUpdateType. Default: GroupUpdateType.LIBRARYACCESSDENIED.
    """

    group_id: UUID | Unset = UNSET
    data: str | Unset = UNSET
    type_: GroupUpdateType | Unset = GroupUpdateType.LIBRARYACCESSDENIED
