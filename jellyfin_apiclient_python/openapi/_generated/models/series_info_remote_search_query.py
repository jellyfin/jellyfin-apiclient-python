...
class SeriesInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (None | SeriesInfo | Unset):
        item_id (UUID | Unset):
    ...
    search_info: None | SeriesInfo | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> None | SeriesInfo | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | SeriesInfo | Unset, data)
