...
class AlbumInfo:
    ...
    Attributes:
        ...
        provider_ids (AlbumInfoProviderIdsType0 | None | Unset): Gets or sets the provider ids.
        ...
        album_artists (list[str] | Unset): Gets or sets the album artist.
        artist_provider_ids (AlbumInfoArtistProviderIds | Unset): Gets or sets the artist provider ids.
    ...
    provider_ids: AlbumInfoProviderIdsType0 | None | Unset = UNSET
    ...
    album_artists: list[str] | Unset = UNSET
    artist_provider_ids: AlbumInfoArtistProviderIds | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        artist_provider_ids: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_ids(
            data: object,
        ) -> AlbumInfoProviderIdsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(AlbumInfoProviderIdsType0 | None | Unset, data)
        ...
        artist_provider_ids: AlbumInfoArtistProviderIds | Unset
