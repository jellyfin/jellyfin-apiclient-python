...
class MusicVideoInfo:
    ...
    Attributes:
        ...
        provider_ids (MusicVideoInfoProviderIdsType0 | None | Unset): Gets or sets the provider ids.
    ...
    provider_ids: MusicVideoInfoProviderIdsType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_ids(
            data: object,
        ) -> MusicVideoInfoProviderIdsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(MusicVideoInfoProviderIdsType0 | None | Unset, data)
