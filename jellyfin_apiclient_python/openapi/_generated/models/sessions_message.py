...
class SessionsMessage:
    ...
    Attributes:
        data (list[SessionInfoDto] | None | Unset): Gets or sets the data.
        ...
        message_type (SessionMessageType | Unset): The different kinds of messages that are used in the WebSocket api.
            Default: SessionMessageType.SESSIONS.
    """

    data: list[SessionInfoDto] | None | Unset = UNSET
    message_id: UUID | Unset = UNSET
    message_type: SessionMessageType | Unset = SessionMessageType.SESSIONS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[SessionInfoDto] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(list[SessionInfoDto] | None | Unset, data)
