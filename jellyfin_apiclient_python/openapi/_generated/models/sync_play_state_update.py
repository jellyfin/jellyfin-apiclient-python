...
class SyncPlayStateUpdate:
    ...
    Attributes:
        ...
        data (GroupStateUpdate | Unset): Class GroupStateUpdate.
        type_ (GroupUpdateType | Unset): Enum GroupUpdateType. Default: GroupUpdateType.STATEUPDATE.
    """

    group_id: UUID | Unset = UNSET
    data: GroupStateUpdate | Unset = UNSET
    type_: GroupUpdateType | Unset = GroupUpdateType.STATEUPDATE
