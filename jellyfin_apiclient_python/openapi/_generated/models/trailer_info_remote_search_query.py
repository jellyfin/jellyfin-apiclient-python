...
class TrailerInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (None | TrailerInfo | Unset):
        item_id (UUID | Unset):
    ...
    search_info: None | TrailerInfo | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> None | TrailerInfo | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | TrailerInfo | Unset, data)
