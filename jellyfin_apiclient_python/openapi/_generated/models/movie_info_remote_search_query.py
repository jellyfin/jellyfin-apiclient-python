...
class MovieInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (MovieInfo | None | Unset):
        item_id (UUID | Unset):
    ...
    search_info: MovieInfo | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> MovieInfo | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(MovieInfo | None | Unset, data)
